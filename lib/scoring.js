...
function scoreProteinSource(ingredientStr) {
  ...
  // First animal protein (6 pts named, 1 generic)
  ...
  // Second animal protein (3 pts named, 1 generic)
  ...
  // Third+ animal protein (2 pts named, 1 generic)
  let thirdPts = 0;
  ...
  // Species diversity bonus: +2 for 2 groups, +3 for 3+ groups
  let diversityPts = 0;
