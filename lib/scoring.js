...
function scoreProteinSource(ingredientStr) {
  ...
  // First animal protein (7 pts named, 1 generic) — matches Python source of truth
  ...
  // Second animal protein (5 pts named, 1 generic)
  ...
  // Third+ animal protein (3 pts named, 1 generic)
  let thirdPts = 0;
  ...
  // Species diversity (tracked for display, no bonus points — matches Python)
