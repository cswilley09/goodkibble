    ...
    <div style={{ marginBottom: 20 }}>
      ...
      <div style={{ background: '#fff', borderRadius: 20, border: '2px solid #A32D2D', overflow: 'hidden', marginBottom: isPro ? 0 : 16 }}>
        <div style={{
          ...
          <div>
            <div style={{ fontSize: 14, fontWeight: 700, color: '#fff', fontFamily: "'DM Sans', sans-serif" }}>Active Recall Alert</div>
            <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.7)', fontFamily: "'DM Sans', sans-serif" }}>{formatDate(matchedRecall.recall_date || matchedRecall.report_date)}</div>
          </div>
        </div>
        <div style={{ padding: 24 }}>
          <div style={{ fontSize: 15, fontWeight: 700, color: '#1a1612', marginBottom: 6, fontFamily: "'DM Sans', sans-serif" }}>{matchedRecall.brand_name} — {matchedRecall.product_description}</div>
          {matchedRecall.reason && matchedRecall.reason !== matchedRecall.product_description && (
            <div style={{ fontSize: 13, color: '#5a5248', lineHeight: 1.6, marginBottom: 12, fontFamily: "'DM Sans', sans-serif" }}>{matchedRecall.reason}</div>
          )}
          <div style={{
      ...
      {!isPro && (
        <div style={{
          ...
          <div style={{ fontSize: 13, fontWeight: 700, color: '#C9A84C', marginBottom: 6, fontFamily: "'DM Sans', sans-serif" }}>You found this recall by checking manually.</div>
          <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: 20, fontWeight: 800, color: '#fff', margin: '0 0 8px' }}>What about the next one?</h3>
          <p style={{ fontSize: 13, color: '#8a7e72', maxWidth: 380, margin: '0 auto 16px', lineHeight: 1.6, fontFamily: "'DM Sans', sans-serif" }}>
