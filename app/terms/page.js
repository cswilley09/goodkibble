...
const h3Style = { fontFamily: "'Inter', sans-serif", fontSize: 16, fontWeight: 700, color: '#1C1814', marginBottom: 8, marginTop: 16 };
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#faf8f5' }}>
      ...
      <div style={{ maxWidth: 740, margin: '0 auto', padding: '48px 24px 80px' }}>
        ...
        <h1 className="page-title" style={{ fontFamily: "'Instrument Serif', serif", fontSize: 'clamp(28px, 4vw, 40px)', fontWeight: 800, color: '#1C1814', marginBottom: 40 }}>Terms of Service</h1>
      ...
      <div className="footer-bar" style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16, fontSize: 13, color: 'rgba(28,24,20,0.40)' }}>
