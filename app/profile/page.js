        ...
        <div style={{
          ...
          {matches.map(b => (
            <div key={b} onMouseDown={e => { e.preventDefault(); setText(b); onChange(b); setOpen(false); }}
              style={{ padding: '9px 14px', fontSize: 14, cursor: 'pointer', fontFamily: "'Inter', sans-serif", color: b === value ? '#C8941F' : '#1C1814', fontWeight: b === value ? 600 : 400 }}
...
function FoodPicker({ value, onChange }) {
  ...
  if (value && value.name) {
    return (
      <div style={{ background: '#f7efd8', border: '1.5px solid #C8941F', borderRadius: 10, padding: '10px 14px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flexShrink: 0 }}>
      <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`}>
        ...
        <text x={size/2} y={size/2} textAnchor="middle" dominantBaseline="central"
          style={{ fontSize: size * 0.32, fontWeight: 700, fontFamily: "'Inter', sans-serif", fill: '#1C1814' }}>
          {score}
        </text>
      </svg>
                  ...
                  <>
                      ...
                      <div style={{ marginTop: 20, paddingTop: 20, borderTop: '1px solid #f5f2ec' }}>
                        ...
                        <div style={{ position: 'relative', height: 8, borderRadius: 100, background: 'linear-gradient(to right, #D97B2A, #EF9F27, #7BAF2E, #639922)', overflow: 'visible' }}>
                          <div style={{
                            ...
                            background: '#1C1814', border: '3px solid #fff',
                    ...
                    <div style={{ display: 'flex', gap: 10, marginTop: 20, flexWrap: 'wrap', alignItems: 'center' }}>
                      <button onClick={() => goToFood(currentFoodData)} style={{
                        padding: '10px 24px', borderRadius: 100, background: '#1C1814', color: '#F4EFE4',
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                  ...
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
                    {dog.priorities.map(p => (
                      <span key={p} style={{
                        ...
                        background: '#f7efd8', border: '1px solid #C8941F',
                        fontSize: 11, fontWeight: 600, color: '#1C1814',
                        fontFamily: "'Inter', sans-serif",
                      }}>{p}</span>
                    ))}
                  </div>
              ...
              <div style={{ ...cardStyle, padding: 20 }}>
                ...
                {[
                  ...
                  <div key={item.label} onClick={item.action} style={{
                    ...
                    onMouseEnter={e => (e.currentTarget.style.color = '#C8941F')}
                    onMouseLeave={e => (e.currentTarget.style.color = '#1C1814')}
                  >
                    <span style={{ fontSize: 13, fontWeight: 600 }}>{item.label}</span>
                    <span style={{ fontSize: 13, color: '#C8941F', fontWeight: 600 }}>&rarr;</span>
                  </div>
                ))}
              </div>
              ...
              {!isPro && (
                <div style={{
                  ...
                  <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.7)', lineHeight: 1.5, marginBottom: 16, fontFamily: "'Inter', sans-serif" }}>
                    Recall alerts, ingredient deep-dives, unlimited comparisons, and up to 5 dog profiles.
                  </p>
                  <button onClick={() => router.push('/pro')} style={{
                    width: '100%', padding: '10px 0', borderRadius: 100, background: '#C8941F', color: '#fff',
                    fontSize: 13, fontWeight: 700, border: 'none', cursor: 'pointer',
                    fontFamily: "'Inter', sans-serif",
                  }}>Upgrade to Pro &rarr;</button>
                  <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.5)', marginTop: 8, fontFamily: "'Inter', sans-serif" }}>Starting at $3.99/month &middot; Cancel anytime</div>
                </div>
              )}
            </div>
          </div>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
                ...
                {!editing && (
                  <button onClick={() => {
                    ...
                    padding: '6px 16px', borderRadius: 100, background: 'transparent', color: '#C8941F',
                    fontSize: 12, fontWeight: 600, border: '1.5px solid #C8941F',
                    cursor: 'pointer', fontFamily: "'Inter', sans-serif",
                  }}>Edit</button>
                )}
              </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                  ...
                  <div style={{ display: 'flex', gap: 10, marginTop: 4 }}>
                    <button disabled={saving} onClick={async () => {
                      ...
                      flex: 1, padding: '12px 0', borderRadius: 100, background: '#1C1814', color: '#F4EFE4',
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
                  {dog.priorities.map(p => (
                    <span key={p} style={{
                      ...
                      background: '#f7efd8', border: '1.5px solid #C8941F',
                              ...
                              >
                                {isHighest && (
                                  <span style={{
                                    ...
                                    background: '#C8941F', color: '#fff', padding: '2px 7px',
              ...
              <div style={cardStyle}>
                <div style={{ textAlign: 'center', padding: '32px 0' }}>
                  ...
                  <button onClick={() => router.push('/compare')} style={{
                    padding: '10px 28px', borderRadius: 100, background: '#1C1814', color: '#F4EFE4',
                    fontSize: 13, fontWeight: 600, border: 'none', cursor: 'pointer', fontFamily: "'Inter', sans-serif",
      ...
      {showCancelModal && (
        <>
          ...
          <div style={{
            ...
            <h3 style={{ fontFamily: "'Instrument Serif', serif", fontSize: 20, fontWeight: 800, color: '#1C1814', margin: '0 0 8px' }}>
              Are you sure?
            </h3>
            ...
            <button onClick={() => setShowCancelModal(false)} style={{
              ...
              background: '#1C1814', color: '#F4EFE4', fontSize: 15, fontWeight: 700,
