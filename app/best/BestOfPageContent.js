  ...
  return (
    <div style={{ position: 'relative', width: size, height: size, flexShrink: 0 }}>
      ...
      <div style={{
        ...
        fontSize: 18, fontWeight: 700, fontFamily: "'Inter', sans-serif", color: '#1C1814',
      }}>{score}</div>
    </div>
  );
}
    ...
    <div style={{
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ flex: 1, minWidth: 180 }}>
            ...
            <h3 style={{ margin: '4px 0 0' }}>
              <a href={`/dog-food/${product.brand_slug}/${product.slug}`} style={{
                ...
                color: '#1C1814', textDecoration: 'none', lineHeight: 1.3,
              }}>{product.name}</a>
            </h3>
          </div>
        ...
        <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', alignItems: 'center' }}>
          <a href={`/dog-food/${product.brand_slug}/${product.slug}`} style={{
            fontSize: 13, fontWeight: 600, color: '#1C1814', textDecoration: 'underline',
          ...
          {product.affiliate_url && (
            <a href={product.affiliate_url} target="_blank" rel="noopener noreferrer nofollow" style={{
              ...
              background: '#1C1814', color: '#faf8f5', textDecoration: 'none',
      ...
      <div style={{ maxWidth: 860, margin: '0 auto', padding: '32px 24px 80px' }}>
        ...
        <div style={{
          ...
          <p style={{ fontSize: 14, color: '#5a5248', lineHeight: 1.7, fontFamily: "'Inter', sans-serif" }}>
            ...
            <a href="/how-we-score" style={{ color: '#1C1814', textDecoration: 'underline', textUnderlineOffset: 3 }}>
            ...
            <a href="/discover" style={{ color: '#1C1814', textDecoration: 'underline', textUnderlineOffset: 3 }}>
