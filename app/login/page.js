        ...
        {isLoggedIn ? (
          ...
          <>
            ...
            <form onSubmit={handleSubmit}>
              ...
              {error && (
                <p style={{ fontSize: 13, color: '#b5483a', marginTop: 8, fontFamily: "'DM Sans', sans-serif" }}>{error}</p>
              )}
            ...
            <p style={{ textAlign: 'center', marginTop: 24, fontFamily: "'DM Sans', sans-serif", fontSize: 14, color: '#8a7e72' }}>
              Don&rsquo;t have an account?{' '}
              <a href="/signup" style={{ color: '#C9A84C', fontWeight: 600, textDecoration: 'none' }}>Sign up &rarr;</a>
            </p>
          </>
        ) : (
          <div style={{ textAlign: 'center' }}>
            ...
            <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 'clamp(28px, 5vw, 36px)', fontWeight: 800, color: '#1a1612', margin: '0 0 8px', letterSpacing: -0.5 }}>
              Check your email!
            </h1>
            <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 16, color: '#8a7e72', lineHeight: 1.6, marginBottom: 8 }}>
              We sent a sign-in link to <strong style={{ color: '#C9A84C' }}>{email.trim()}</strong>.
