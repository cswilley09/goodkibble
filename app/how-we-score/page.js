        ...
        <tbody>
          {rows.map((row, i) => (
            <tr key={i} style={{ background: i % 2 === 0 ? '#faf8f5' : '#fff' }}>
              {row.map((cell, j) => (
                <td key={j} style={{ padding: '8px 12px', borderBottom: '1px solid #f0ebe3', color: j === 0 ? '#1C1814' : '#5a5248', fontWeight: j === 1 ? 600 : 400, fontFamily: j === 1 ? "'Inter', sans-serif" : 'inherit' }}>{cell}</td>
              ))}
            </tr>
          ))}
        </tbody>
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#faf8f5' }}>
      ...
      <div style={{ maxWidth: 780, margin: '0 auto', padding: '48px 24px 80px' }}>
        ...
        <div style={{ marginBottom: 56 }}>
          <h2 className="section-h2" style={{ fontFamily: "'Instrument Serif', serif", fontSize: 28, fontWeight: 700, color: '#1C1814', marginBottom: 8 }}>Two layers, clearly separated</h2>
        ...
        <div style={{ marginBottom: 56 }}>
          <h2 className="section-h2" style={{ fontFamily: "'Instrument Serif', serif", fontSize: 28, fontWeight: 700, color: '#1C1814', marginBottom: 16 }}>A living methodology</h2>
